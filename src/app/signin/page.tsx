                ...
                <form>
                  ...
                  <div className="mb-6">
                    <Button
                      ...
                      className="flex h-[50px] w-full items-center justify-center rounded-sm bg-primary px-9 py-4 text-base font-medium text-white shadow-submit duration-300 hover:bg-primary/90 dark:shadow-submit-dark"
                    >
                      {loading ? ( <div className="custom-loader"> </div> ): "Sign in"}
                    </Button>
                  </div>
                </form>
